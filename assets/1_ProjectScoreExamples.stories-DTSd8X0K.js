import{j as e}from"./Comment-C1XdGdyQ.js";import{R as a}from"./index-BBkUAzwr.js";import{P as T,g as E,s as O}from"./ProjectScore-lXZkQOX5.js";import{e as w,D as c,I,M as D}from"./common-CgTZGrRK.js";import"./extends-CCbyfPlC.js";import"./EightElements-vTKz5rqF.js";import"./Measure-CZU_qCav.js";import"./index-B4AGIx-9.js";import"./IntermediatePurpose-C5ss7ifk.js";import"./ObjectiveBox-SGRpufnV.js";const h={title:"pufu-editor/Examples",component:T,parameters:{layout:"fullscreen"},tags:["autodocs"]},s="example1",r="example2",C=()=>!!(window.matchMedia&&window.matchMedia("(max-device-width: 640px)").matches),m={args:{uniqueKey:s,initScore:w,preview:!0,mobile:C()},render:function({...u}){const[x,o]=a.useState(!1),[i,p]=a.useState(""),[d,t]=a.useState("");return e.jsxs(e.Fragment,{children:[e.jsx(c,{scoreKey:s,kind:"json"}),e.jsx(c,{scoreKey:s,kind:"png"}),e.jsx(c,{scoreKey:s,kind:"svg"}),e.jsx(I,{onClick:()=>{const n=E(s);p(n),o(!0),t("")}}),e.jsxs("p",{className:"ml-8",children:["ID: ",s]}),e.jsx(h.component,{...u}),e.jsx(D,{open:x,text:i,error:d,onCancel:()=>o(!1),onChange:n=>{p(n)},onOk:()=>{try{t(""),O(s,i),o(!1)}catch(n){console.error(n),n instanceof Error&&t(n.message)}}})]})}},l={args:{uniqueKey:r,feedback:!0,mobile:C()},render:function({...u}){const[x,o]=a.useState(!1),[i,p]=a.useState(""),[d,t]=a.useState("");return e.jsxs(e.Fragment,{children:[e.jsx(c,{scoreKey:r,kind:"json"}),e.jsx(c,{scoreKey:r,kind:"png"}),e.jsx(c,{scoreKey:r,kind:"svg"}),e.jsx(I,{onClick:()=>{const n=E(r);p(n),o(!0),t("")}}),e.jsxs("p",{className:"ml-8",children:["ID: ",r]}),e.jsx(h.component,{...u}),e.jsx(D,{open:x,text:i,error:d,onCancel:()=>o(!1),onChange:n=>{p(n)},onOk:()=>{try{t(""),O(r,i),o(!1)}catch(n){console.error(n),n instanceof Error&&t(n.message)}}})]})}};var g,k,y;m.parameters={...m.parameters,docs:{...(g=m.parameters)==null?void 0:g.docs,source:{originalSource:`{
  args: {
    uniqueKey: key1,
...
//# sourceMappingURL=1_ProjectScoreExamples.stories-DTSd8X0K.js.map
